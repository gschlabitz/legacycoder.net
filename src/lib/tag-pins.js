...
// coordinate) and for planting the tip on the timeline rail. The hole picks
// up the theme background so it reads as punched-through in either scheme.
export function pinSvg(color, size = 20) {
  return (
